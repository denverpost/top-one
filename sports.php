...
<head>
    ...
    <title>Denver Post Sports Top Story Tracker</title>
...
<body style="margin:0;">
    ...
    <div style="background:#e1e1e1;border-bottom:10px solid #b1b1b1;padding:2em 0;margin:0 0 2em;text-align:center;">
        <h1>Denver Post Sports Top Story Tracker</h1>
    </div>
    <div class="row">
        <div class="large-10 large-centered columns">
            <table style="width:100%;">
                <tr>
                    <th style="font-size:120%;">Top Sports story</th>
...
$html = file_get_html('http://www.denverpost.com/sports/');
...
if (($handlein = fopen("top-sports.csv", "r")) !== FALSE) {
...
if ($newfind) {
	...
	$handleout = fopen("top-sports.csv", "a");
